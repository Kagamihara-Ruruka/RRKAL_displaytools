...
from scripts.validate_adaptive_render_quality_policy_import_boundary import validate_source, validate_target


REPO_ROOT = Path(__file__).resolve().parents[1]
SCRIPT = REPO_ROOT / "scripts" / "validate_adaptive_render_quality_policy_import_boundary.py"
...
class AdaptiveRenderQualityPolicyImportBoundaryTests(unittest.TestCase):
    ...
    def test_extracted_sibling_policy_imports_fail(self):
        snippets = [
            ...
            "from render_core.layer_render_budget_policy import LAYER_RENDER_COSTS\n",
        ]
    ...
    def test_parser_normalizer_provider_imports_fail(self):
        snippets = [
            ...
            "from source_fetcher import fetch_records\n",
    ...
    def test_cli_forbidden_file_exits_nonzero_and_outputs_json(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            target = Path(tmpdir) / "bad_adaptive_render_quality_policy.py"
