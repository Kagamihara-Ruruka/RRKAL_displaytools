"""Tests for the dynamic point presentation count import-boundary checker."""
...
from scripts import validate_displaytools_dynamic_point_presentation_count_import_boundary as checker


class DynamicPointPresentationCountImportBoundaryTest(unittest.TestCase):
    def test_default_target_is_presentation_count_boundary(self) -> None:
        self.assertEqual(
    ...
    def test_forbidden_names_fail(self) -> None:
        snippets = {
            ...
            "source_loss_interpretation": "value = source_loss_claimed\n",
    ...
    def test_checker_does_not_import_target(self) -> None:
        ...
        self.assertNotIn("render_core.dynamic_point_presentation_count_boundary", imported_modules)
        self.assertNotIn("dynamic_point_presentation_count_boundary", imported_modules)
    ...
    def test_module_can_import_safely(self) -> None:
        spec = importlib.util.spec_from_file_location(
            "presentation_count_checker_safe_import",
            "scripts/validate_displaytools_dynamic_point_presentation_count_import_boundary.py",
        )
        ...
        self.assertEqual(str(module.DEFAULT_TARGET), "render_core\\dynamic_point_presentation_count_boundary.py")
