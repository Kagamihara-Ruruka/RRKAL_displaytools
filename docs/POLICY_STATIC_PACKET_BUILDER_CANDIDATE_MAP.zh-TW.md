...
| `LayerRenderBudgetPolicy` | `5137` | `policy_object_candidate` | layer id/kind/records/lod/style profile; output decision dict/text | `LAYER_RENDER_COSTS` | no | no | no | no | yes | Gate A candidate; broader than point policy. |
