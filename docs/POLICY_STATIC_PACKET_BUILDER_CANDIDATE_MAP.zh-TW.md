...
| `AdaptiveRenderQualityPolicy` | `5069` | `policy_object_candidate` | width/height/render_ms/lod/target fps; output decision dict/text | none observed | no | no | no | no | yes | Current gate: `ADAPTIVE_RENDER_QUALITY_POLICY_FIXTURE_PARITY_GATE.zh-TW.md`; timing semantics need care. |
