...
- Smoke 會驗證 runtime pressure snapshot、LayerRenderState packet、work-order schema、target FPS contract、LayerRenderState contract、LOD counter contract 與 heavy overlay defer/cache policy。
