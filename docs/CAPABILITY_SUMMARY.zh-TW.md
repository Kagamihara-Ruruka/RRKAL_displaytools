...
- 未完成的 embedded live preview、timeline、undo stack 會以 🚧 施工中標示；Brush/Mask 暫不納入本輪 UI。
...
- Layer stack 下一步是 selected layer 的完整疆域 feature identity、開放線段面域推論與更完整 renderer diagnostics。
