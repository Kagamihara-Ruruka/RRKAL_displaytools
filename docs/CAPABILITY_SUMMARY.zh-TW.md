...
- Smoke 目前檢查：
  ...
  - Renderer capabilities JSON 與 `preview_frame_stream` / `active_layer_diagnostics` / `timeline_handoff` / `ui_handoff_contracts` schema gate。
