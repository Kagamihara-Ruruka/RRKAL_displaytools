...
If this gate is accepted, the next low-risk step is a movement preimplementation gate or import-boundary checker for a future `AdaptiveRenderQualityPolicy` helper module.
