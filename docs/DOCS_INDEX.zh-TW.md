...
- `DISPLAYTOOLS_CANVAS_CREATION_ORDER_DEPTH_HYPOTHESIS_GATE.zh-TW.md`: docs/test-only canvas creation order depth hypothesis gate recording u_o's Genesis-like design-intent axis as `L1_design_intent_hypothesis` for c_3 layer-depth bias without replacing git, dependency, ablation, or lithology evidence.
- `DISPLAYTOOLS_CANVAS_CREATION_ORDER_DEPTH_HYPOTHESIS_VALIDATION_GATE.zh-TW.md`: docs/test-only validation gate comparing the Genesis-like canvas depth axis with known c_3 lithology and interface strategy evidence, supporting only `L1_supported_design_intent_hypothesis` without L2 or extraction authorization.
...
- [Dynamic Point LOD View-frame One-shot Runtime Probe Execution Gate](DISPLAYTOOLS_DYNAMIC_POINT_LOD_VIEW_FRAME_ONE_SHOT_RUNTIME_PROBE_EXECUTION_GATE.zh-TW.md)

## Dynamic point LOD view-frame one-shot runtime probe result interpretation gate

- [Dynamic Point LOD View-frame One-shot Runtime Probe Result Interpretation Gate](DISPLAYTOOLS_DYNAMIC_POINT_LOD_VIEW_FRAME_ONE_SHOT_RUNTIME_PROBE_RESULT_INTERPRETATION_GATE.zh-TW.md)

## Dynamic point LOD view-frame sampling visibility followup planning gate

- [Dynamic Point LOD View-frame Sampling Visibility Followup Planning Gate](DISPLAYTOOLS_DYNAMIC_POINT_LOD_VIEW_FRAME_SAMPLING_VISIBILITY_FOLLOWUP_PLANNING_GATE.zh-TW.md)
...
- [Dynamic Point LOD View-frame Presentation Count Import-Boundary Checker Planning Gate](DISPLAYTOOLS_DYNAMIC_POINT_LOD_VIEW_FRAME_PRESENTATION_COUNT_IMPORT_BOUNDARY_CHECKER_PLANNING_GATE.zh-TW.md)
...
- [Dynamic Point LOD View-frame Computed-But-Hidden Minimal Extraction Planning Gate](DISPLAYTOOLS_DYNAMIC_POINT_LOD_VIEW_FRAME_COMPUTED_BUT_HIDDEN_MINIMAL_EXTRACTION_PLANNING_GATE.zh-TW.md)
...
- [Dynamic Point LOD View-Frame Source-Lineage Guard Minimal Extraction Planning Gate](DISPLAYTOOLS_DYNAMIC_POINT_LOD_VIEW_FRAME_SOURCE_LINEAGE_GUARD_MINIMAL_EXTRACTION_PLANNING_GATE.zh-TW.md)
