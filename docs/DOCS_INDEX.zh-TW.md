...
- `DISPLAYTOOLS_TERRAIN_BATHYMETRY_IMPORT_BOUNDARY_CHECKER_GATE.zh-TW.md`: tooling/docs-only AST import/name boundary checker gate for the future `render_core\terrain_bathymetry_boundary.py` descriptor helper target, with missing-candidate pass and string-label allowance.
