...
[ordered]@{
    ...
    first_commands = @(
        ...
        "py -3 scripts\export_display_shell_render_matrix.py",
        "powershell -NoProfile -ExecutionPolicy Bypass -File scripts\check_display_shell_render_matrix.ps1",
        "powershell -NoProfile -ExecutionPolicy Bypass -File scripts\check_display_core_import_boundary.ps1",
        "powershell -NoProfile -ExecutionPolicy Bypass -File scripts\inspect_earth_canvas_runtime_boundary.ps1",
