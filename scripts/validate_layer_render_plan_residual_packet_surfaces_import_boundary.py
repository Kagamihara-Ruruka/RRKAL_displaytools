"""Validate import boundaries for a future residual packet-surface helper.
...
SCHEMA = "rrkal_displaytools.layer_render_plan_residual_packet_surfaces_import_boundary.v1"
DEFAULT_TARGET = Path("render_core/layer_render_plan_residual_packet_surfaces.py")
...
FORBIDDEN_IMPORT_PREFIXES = (
    ...
    "render_core.layer_render_plan_compiled_reused_packets",
    "render_core.preview",
...
def validate_source(source: str, source_name: str = "<memory>") -> dict[str, object]:
    ...
    return {
        ...
        "allowed_future_helper_behavior": "pure_residual_render_plan_dict_list_scalar_packet_surfaces_only",
        "string_labels_allowed_as_data": True,
        "alpha_helpers_excluded": True,
...
def validate_target(path: Path) -> dict[str, object]:
    if not path.exists():
        return {
            ...
            "apply_path_excluded": True,
            "metadata_artifact_writers_forbidden": True,
            "boundary": "Candidate residual packet-surface helper module is not present yet; no target module was imported or executed.",
        }
...
def run_negative_self_test() -> dict[str, object]:
    snippets = {
        ...
        "pyais": "import pyais\n",
        "render_plan_module": "from render_core.render_plan import build_layer_render_plan_runtime_snapshot\n",
        ...
        "compiled_reused": "from render_core.layer_render_plan_compiled_reused_packets import build_compiled_layer_render_plan_packet\n",
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate residual render-plan packet-surface import boundaries."
    )
