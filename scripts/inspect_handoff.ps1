...
$summary = [ordered]@{
    ...
    reviewer_packet_export = @{
        ...
        no_gui_export_script = $launchPacket.reviewer_packet_export.no_gui_export_script
        no_gui_export_command = $launchPacket.reviewer_packet_export.no_gui_export_command
        ...
        compose_parity_precommit_gate_summary_field = "compose_parity_precommit_gate_summary"
    ...
    layer_render_plan_performance = @{
        ...
        runtime_pressure_snapshot_schema = $layerRenderPlanPerformance.runtime_pressure_snapshot_schema
        runtime_pressure_snapshot_field = $layerRenderPlanPerformance.runtime_pressure_snapshot_field
        layer_render_state_packet_schema = $layerRenderPlanPerformance.layer_render_state_packet_schema
        layer_render_state_packet_field = $layerRenderPlanPerformance.layer_render_state_packet_field
        lod_counter_packet_schema = $layerRenderPlanPerformance.lod_counter_packet_schema
        lod_counter_packet_field = $layerRenderPlanPerformance.lod_counter_packet_field
        heavy_overlay_defer_cache_snapshot_schema = $layerRenderPlanPerformance.heavy_overlay_defer_cache_snapshot_schema
        heavy_overlay_defer_cache_snapshot_field = $layerRenderPlanPerformance.heavy_overlay_defer_cache_snapshot_field
        runtime_optimization_review_summary_schema = $layerRenderPlanPerformance.runtime_optimization_review_summary_schema
        runtime_optimization_review_summary_helper = $layerRenderPlanPerformance.runtime_optimization_review_summary_helper
        runtime_optimization_review_summary_field = $layerRenderPlanPerformance.runtime_optimization_review_summary_field
        ...
        composition_dispatch_packet_helper = $layerRenderPlanPerformance.composition_dispatch_packet_helper
        composition_timing_packet_helper = $layerRenderPlanPerformance.composition_timing_packet_helper
        ...
        compiled_plan_adapter_payload_schema = $layerRenderPlanPerformance.compiled_plan_adapter_payload_schema
        compiled_plan_adapter_payload_helper = $layerRenderPlanPerformance.compiled_plan_adapter_payload_helper
        compiled_plan_adapter_payload_field = $layerRenderPlanPerformance.compiled_plan_adapter_payload_field
        compiled_plan_adapter_payload_summary_schema = $layerRenderPlanPerformance.compiled_plan_adapter_payload_summary_schema
        compiled_plan_adapter_payload_summary_field = $layerRenderPlanPerformance.compiled_plan_adapter_payload_summary_field
        compiled_plan_adapter_payload_status_field = $layerRenderPlanPerformance.compiled_plan_adapter_payload_status_field
        compiled_plan_adapter_payload_contract_schema = $layerRenderPlanPerformance.compiled_plan_adapter_payload_contract_schema
        compiled_plan_adapter_payload_contract_field = $layerRenderPlanPerformance.compiled_plan_adapter_payload_contract_field
        compiled_plan_adapter_payload_contract_status_field = $layerRenderPlanPerformance.compiled_plan_adapter_payload_contract_status_field
        compiled_plan_adapter_payload_primary_gate = $layerRenderPlanPerformance.compiled_plan_adapter_payload_primary_gate
        ...
        compose_run_parity_smoke_precommit_command = $layerRenderPlanPerformance.compose_run_parity_smoke_precommit_command
        compose_run_parity_smoke_validates = $layerRenderPlanPerformance.compose_run_parity_smoke_validates
        compose_run_parity_smoke_pass_fields = $layerRenderPlanPerformance.compose_run_parity_smoke_pass_fields
        compose_run_parity_artifact_runner_schema = $layerRenderPlanPerformance.compose_run_parity_artifact_runner_schema
        compose_run_parity_artifact_runner_script = $layerRenderPlanPerformance.compose_run_parity_artifact_runner_script
        compose_run_parity_artifact_workflow_schema = $layerRenderPlanPerformance.compose_run_parity_artifact_workflow.schema
        compose_run_parity_artifact_workflow = $layerRenderPlanPerformance.compose_run_parity_artifact_workflow
        compose_run_parity_summary_contract_schema = $layerRenderPlanPerformance.compose_run_parity_summary_contract.schema
        compose_run_parity_summary_contract = $layerRenderPlanPerformance.compose_run_parity_summary_contract
