...
$summary = [ordered]@{
    ...
    current_capabilities = @(
        ...
        [ordered]@{
            ...
            description = "Layer render-plan performance now exposes the allowed post-decoupling optimization scope plus runtime_pressure_snapshot, layer_render_state, lod_counters and heavy_overlay_defer_cache metadata for target-FPS pressure, layer state, LOD and overlay defer/cache decisions; compression and RendererSkinAsset work stay out of displaytools."
