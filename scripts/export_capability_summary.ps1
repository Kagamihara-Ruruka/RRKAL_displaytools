...
$summary = [ordered]@{
    ...
    current_capabilities = @(
        ...
        [ordered]@{
            ...
            description = "Layer render-plan performance now exposes the allowed post-decoupling optimization scope plus runtime_pressure_snapshot metadata for target-FPS pressure, LOD and heavy overlay defer/cache counters; compression and RendererSkinAsset work stay out of displaytools."
