...
def pin_projection_contract_packet() -> dict[str, Any]:
    return {
        ...
        "inputs": [
            ...
            "pin.longitude",
            "pin.label_priority",
            "pin.coordinate_source",
            "pin.coordinate_source_label",
            "camera.yaw",
            "camera.pitch",
            "camera.zoom",
            "viewport.width",
        ...
        "occlusion_status_values": ["visible", "behind_horizon", "off_viewport", "invalid"],
        ...
        "coordinate_source_fields": ["coordinate_source", "coordinate_source_label", "placement"],
        "coordinate_source_values": ["manual_lat_lon", "renderer_globe_raycast", "qt_canvas_estimate"],
        "qt_ui_affordances": [
            "pin_cursor_fill_status_row",
            "pin_coordinate_source_metadata",
            "pin_list_source_summary",
            "projection_rotation_occlusion_note",
            "pin_occlusion_legend",
        ],
        ...
        "qt_occlusion_legend_object": "pinOcclusionLegend",
        "qt_occlusion_legend_text": "Pin occlusion: visible=view_z > horizon_eps and inside viewport; hidden=behind_horizon/off_viewport/invalid; terrain depth mask remains a backend refinement.",
